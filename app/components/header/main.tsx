  ...
  return (
    <div>
      ...
      <div className="flex flex-row-reverse gap-6 items-center absolute top-2 right-2 z-10">
        ...
        <ToggleSwitch handleSwitchChange={handleSwitchChange} isDarkMode={isDarkMode} />
        <BackgroundDesc isDarkMode={isDarkMode} />
        <NavigatorPermisson isDarkMode={isDarkMode} navigatorPermission={navigatorPermission} temperature={temperature} temperatureUnits={temperatureUnits} wheatherIcon={wheatherIcon} humidity={humidity} />
